...
//   pendingProperty?: PropertyHolding | undefined;
// }
...
//   // Wild, life-event, and property cards are all wild-like: playable on any
//   // color or value.
...
//     // Life/property cards can't be used to dodge a pending penalty either.
//     if ((color === "life" || color === "property") && cardId !== "wild_draw4")
//       return false;
//   }
//   return true;
// }
...
// // Amounts for the "life" cards — used only to predict whether playing your
// // last card would actually win before you commit to it. Source of truth for
// // the real payout is convex/game.ts; duplicated here for the same reason the
// // rest of this file duplicates parseCard/canPlayCard.
// const LIFE_AMOUNTS: Record<string, number> = {
//   life_lottery: 10000,
//   life_bonus: 1500,
//   life_gift: 500,
//   life_carrepair: -400,
...
//   // of surprising them with a forced draw-2 afterward.
//   const predictLastCardOutcome = (cardId: string) => {
//     const { color } = parseCard(cardId);
//     const delta = color === "life" ? (LIFE_AMOUNTS[cardId] ?? 0) : 0;
//     // Property cards don't add wealth until accepted, so they don't help you
//     // win on the same turn you play them.
//     const projectedWealth = myMoney + delta + myPropertyValue;
//     return {
...
//         </div>
//         <div className="flex items-center gap-2">
//           {/* Money / property HUD — the wealth this player needs to be
//               highest in order to win when they go out. */}
//           <div
//             className="flex items-center gap-2 px-3 py-1.5 rounded-xl border text-xs font-bold backdrop-blur-sm"
//             style={{
//               borderColor:
...
//             }}
//             title="Cash + property value"
//           >
//             {richestUserId === currentUserId ? "👑" : "💰"} $
//             {myMoney.toLocaleString()}
//             {myPropertyValue > 0 && (
//               <span className="text-white/50 font-medium">
//                 +${myPropertyValue.toLocaleString()} 🏠
//               </span>
//             )}
//           </div>
//           <button
...
//                     {oppHand.length}
//                   </span>
//                   <span className="px-1.5 py-0.5 rounded-full bg-amber-400/20 text-amber-200 font-bold text-[10px]">
//                     ${oppWealth.toLocaleString()}
//                   </span>
//                 </motion.div>
...
//               <h3 className="font-black text-2xl mb-1 text-white tracking-tight">
//                 {myPlayer.pendingProperty.name}
//               </h3>
//               <p className="text-white/60 text-sm mb-1">
//                 Price: ${myPlayer.pendingProperty.price.toLocaleString()}
//               </p>
//               <p className="text-white/40 text-xs mb-5">
//                 Worth ${myPlayer.pendingProperty.value.toLocaleString()} toward
//                 your total wealth if you buy it. You have $
//                 {myMoney.toLocaleString()} cash.
//               </p>
...
//   salaryNotice?: { turnCount: number; amount: number; at: number } | undefined;
// }
...
//     setSalaryModal({ turnCount: notice.turnCount, amount: notice.amount });
//     play("cardDeal");
//   }, [game.salaryNotice, play]);
...
//                 Total wealth: ${(myMoney + myPropertyValue).toLocaleString()}
//               </div>
//             )}
//           </div>
//         </div>
...
//                 You earned ${salaryModal.amount.toLocaleString()}!
//               </h3>
